...
class testPlayer(unittest.TestCase):
    ...
    def test_get_carre_two_carres(self):
    	...
    	hand = [
    	{'rank':0,'value':7},{'rank':1,'value':12},
    	{'rank':1,'value':7},{'rank':2,'value':12},
    	{'rank':2,'value':7},{'rank':3,'value':12},
    	{'rank':3,'value':7},{'rank':0,'value':12}
    	]
    	player.get_hand(hand)

    	expected_result = [('carre', 7),('carre', 12)]
    	result = player.get_carre()
    	self.assertEqual(result, expected_result)
